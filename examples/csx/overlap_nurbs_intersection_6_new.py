...
if args.viewer:
    try:
        ...
        srf = viewer.add_nurbs_surface(s1 ,color=(0.7, 0.7, 0.7, 1), surface_color=(0.5, 0.5, 0.9, 0.1), )
        srf = viewer.add_nurbs_surface(s2, color=(0.7, 0.7, 0.7, 1), surface_color=(0.5, 0.5, 0.9, 0.1), )
        viewer.run()
