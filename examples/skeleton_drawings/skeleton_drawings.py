# -*- coding: utf-8 -*-
"""extract_contours_from_drawings.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wQwH3qS1Y2x-DUjIZwI3gu1G5nXZshmn
...
# ! git clone https://github.com/LingDong-/skeleton-tracing.git
# ! apt-get update -y
...
# ! apt-get install swig gcc libpython3-dev -y
#
# !pip install git+https://github.com/contextmachine/mmcore@tiny

# @title Setup environment variables {"run":"auto","vertical-output":true,"display-mode":"form"}


# Commented out IPython magic to ensure Python compatibility.
# # @title Build from source {"run":"auto","vertical-output":true,"display-mode":"form"}
# %%bash
#
# cd "$PWD/skeleton-tracing/swig" &&
# swig -python trace_skeleton.i
# gcc -fPIC -O3 -c trace_skeleton.c trace_skeleton_wrap.c $(python3-config --includes)
# gcc -shared $(python3-config --ldflags) *.o -o _trace_skeleton.so
# python3 -c "import site; print(site.getsitepackages())"
# sudo cp _trace_skeleton.so $(python3 -c "import site; print(site.getsitepackages()[0])")
# python3 -c "import trace_skeleton; print(trace_skeleton)"
# cp "/content/skeleton-tracing/swig/trace_skeleton.py" "/content/trace_skeleton.py"
# cd "../../"

# @title Add dependencies {"run":"auto","vertical-output":true,"display-mode":"form"}
