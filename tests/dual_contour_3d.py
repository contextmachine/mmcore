...
if __name__ == "__main__":
    ...
    from mmcore.geom.implicit import Intersection3D, Sub3D
    import numpy as np

    from mmcore.numeric.intersection.implicit_implicit import (
        ImplicitIntersectionCurve,
        iterate_curves,
    )
    ...
    x, y, v, u, z = [
        [
            [12.359112840551504, -7.5948049557495425, 0.0],
            [2.656625109045951, 1.2155741170561933, 0.0],
        ],
        [
    ...
    mesh = dual_contour_3d( inter, inter.gradient,   xmin=-3.0, xmax=3.0,
        ymin=-3.0, ymax=3.0,
        zmin=-3.0, zmax=3.0,
        cell_size=0.05,
        adaptive=True,
