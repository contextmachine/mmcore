...
def run_test_ssx(s1, s2, spt,tol, expected_components, expected_isolated_points):

    result = ssx(s1, s2, spt=spt,tol=tol)
    assert len(result[0]) == expected_components, f"An output of {expected_components} components was expected, but {len(result[0])} was obtained. (spt={spt}, tol={tol})"
    assert len(result[1]) == expected_isolated_points, f"An output of {expected_isolated_points} isolated points was expected, but {len(result[1])} was obtained. (spt={spt}, tol={tol})"

def prepare_surface_case1():
    pts1 = np.array(
        [
            [-25.0, -25.0, -10.0],
            [-25.0, -15.0, -5.0],
    ...
    surf = NURBSSurface(pts1, (3, 3))

    return surf
def prepare_surfaces_case2():
...
def prepare_surfaces_case3():
    pts1 = [[0.0, 13.000000000000007, 8.0], [4.4000000000000004, 13.000000000000007, 9.0],
            [8.8000000000000007, 13.000000000000007, 9.0], [11.0, 13.000000000000005, 7.0],
            [8.8000000000000007, 13.000000000000004, 5.0], [4.4000000000000004, 13.000000000000004, 5.0],
            [-0.0024241090980669623, 13.000000000000005, 5.9991422999185158],
            [-4.4048482181961344, 13.000000000000005, 6.9982845998370315],
            [-8.8000000000000007, 13.000000000000005, 7.0], [-11.0, 13.000000000000004, 5.0],
            [-8.8000000000000007, 13.000000000000002, 3.0], [-4.4000000000000004, 13.000000000000002, 3.0],
            [0.0, 13.000000000000004, 4.0], [4.4000000000000004, 13.000000000000004, 5.0],
            [8.8000000000000007, 13.000000000000004, 5.0], [11.0, 13.000000000000002, 3.0],
            [8.8000000000000007, 13.0, 1.0], [4.4000000000000004, 13.0, 1.0],
            [-0.0024241090980669623, 13.000000000000002, 1.9991422999185158],
            [-4.4048482181961344, 13.000000000000002, 2.9982845998370315],
            [-8.8000000000000007, 13.000000000000002, 3.0], [-11.0, 13.0, 1.0],
            [-8.8000000000000007, 12.999999999999998, -1.0], [-4.4000000000000004, 12.999999999999998, -1.0],
            [0.0, 13.0, 0.0], [4.4000000000000004, 13.0, 1.0], [8.8000000000000007, 13.0, 1.0],
            [11.0, 12.999999999999998, -1.0], [8.8000000000000007, 12.999999999999996, -3.0],
            [4.4000000000000004, 12.999999999999996, -3.0],
            [-0.0024241090980669623, 12.999999999999998, -2.0008577000814842],
            [-4.4048482181961344, 12.999999999999998, -1.0017154001629685],
            [-8.8000000000000007, 12.999999999999998, -1.0], [-11.0, 12.999999999999996, -3.0],
            [-8.8000000000000007, 12.999999999999995, -5.0], [-4.4000000000000004, 12.999999999999995, -5.0],
            [0.0, 12.999999999999996, -4.0], [4.4000000000000004, 12.999999999999996, -3.0],
            [8.8000000000000007, 12.999999999999996, -3.0], [11.0, 12.999999999999995, -5.0],
            [8.8000000000000007, 12.999999999999993, -7.0], [4.4000000000000004, 12.999999999999993, -7.0],
            [-0.0024241090980669623, 12.999999999999995, -6.0008577000814824],
            [-4.4048482181961344, 12.999999999999995, -5.0017154001629685],
            [-8.8000000000000007, 12.999999999999995, -5.0], [-11.0, 12.999999999999993, -7.0],
            [-8.8000000000000007, 12.999999999999991, -9.0], [-4.4000000000000004, 12.999999999999991, -9.0],
            [0.0, 12.999999999999993, -8.0]]
    pts2 = [[0.0, -9.9999999999999929, 8.0], [4.4000000000000004, -9.9999999999999929, 9.0],
            [8.8000000000000007, -9.9999999999999929, 9.0], [11.0, -9.9999999999999947, 7.0],
            [8.8000000000000007, -9.9999999999999964, 5.0], [4.4000000000000004, -9.9999999999999964, 5.0],
            [-0.0024241090980669623, -9.9999999999999947, 5.9991422999185158],
            [-4.4048482181961344, -9.9999999999999947, 6.9982845998370315],
            [-8.8000000000000007, -9.9999999999999947, 7.0], [-11.0, -9.9999999999999964, 5.0],
            [-8.8000000000000007, -9.9999999999999982, 3.0], [-4.4000000000000004, -9.9999999999999982, 3.0],
            [0.0, -9.9999999999999964, 4.0], [4.4000000000000004, -9.9999999999999964, 5.0],
            [8.8000000000000007, -9.9999999999999964, 5.0], [11.0, -9.9999999999999982, 3.0],
            [8.8000000000000007, -10.0, 1.0], [4.4000000000000004, -10.0, 1.0],
            [-0.0024241090980669623, -9.9999999999999982, 1.9991422999185158],
            [-4.4048482181961344, -9.9999999999999982, 2.9982845998370315],
            [-8.8000000000000007, -9.9999999999999982, 3.0], [-11.0, -10.0, 1.0],
            [-8.8000000000000007, -10.000000000000002, -1.0], [-4.4000000000000004, -10.000000000000002, -1.0],
            [0.0, -10.0, 0.0], [4.4000000000000004, -10.0, 1.0], [8.8000000000000007, -10.0, 1.0],
            [11.0, -10.000000000000002, -1.0], [8.8000000000000007, -10.000000000000004, -3.0],
            [4.4000000000000004, -10.000000000000004, -3.0],
            [-0.0024241090980669623, -10.000000000000002, -2.0008577000814842],
            [-4.4048482181961344, -10.000000000000002, -1.0017154001629685],
            [-8.8000000000000007, -10.000000000000002, -1.0], [-11.0, -10.000000000000004, -3.0],
            [-8.8000000000000007, -10.000000000000005, -5.0], [-4.4000000000000004, -10.000000000000005, -5.0],
            [0.0, -10.000000000000004, -4.0], [4.4000000000000004, -10.000000000000004, -3.0],
            [8.8000000000000007, -10.000000000000004, -3.0], [11.0, -10.000000000000005, -5.0],
            [8.8000000000000007, -10.000000000000007, -7.0], [4.4000000000000004, -10.000000000000007, -7.0],
            [-0.0024241090980669623, -10.000000000000005, -6.0008577000814824],
            [-4.4048482181961344, -10.000000000000005, -5.0017154001629685],
            [-8.8000000000000007, -10.000000000000005, -5.0], [-11.0, -10.000000000000007, -7.0],
            [-8.8000000000000007, -10.000000000000009, -9.0], [-4.4000000000000004, -10.000000000000009, -9.0],
            [0.0, -10.000000000000007, -8.0]]
    ...
    s1 = ruled(crv1, crv2)
    s2 = ruled(NURBSCurve(np.array([[-19.866327395603214, 1.6639891981988859, -0.026559537166892966],
                                    [-13.079018853432281, 24.600246438290654, -14.581989677486053]]
                                   ), 1),
               NURBSCurve(np.array([[8.2292140025329292, 1.6639891981988872, 11.166654499054477],
                                    [15.016522544703857, 24.600246438290647, -1.4808235635243387]]
                                   ), 1))

    return s1,s2

def test_surf_extend():
    prepare_surface_case1
    s1,s2=prepare_surfaces_case1()
    run_test_ssx(s1,s2,0.001,1e-7, 5,0)

def test_ssx_1_1_2():
    s1,s2=prepare_surfaces_case1()
    run_test_ssx(s2,s1,0.001,1e-7, 5,0)

def test_ssx_1_2_1():
    s1,s2=prepare_surfaces_case1()
    run_test_ssx(s1,s2,0.01,1e-5, 5,0)

def test_ssx_1_2_2():
    s1,s2=prepare_surfaces_case1()
    run_test_ssx(s2,s1,0.01,1e-5, 5,0)

def test_ssx_1_3_1():
    s1,s2=prepare_surfaces_case1()
    run_test_ssx(s1,s2,0.1,1e-5, 5,0)

def test_ssx_1_3_2():
    s1,s2=prepare_surfaces_case1()
    run_test_ssx(s2,s1,0.1,1e-5, 5,0)


def test_ssx_2_1_1():
    s1,s2=prepare_surfaces_case2()
    run_test_ssx(s1,s2,0.01,1e-7, 11,0)


def test_ssx_2_1_2():
    s1, s2 = prepare_surfaces_case2()
    run_test_ssx(s2, s1, 0.01, 1e-7, 11, 0)


def test_ssx_3_1_1():
    s1,s2=prepare_surfaces_case3()
    run_test_ssx(s1,s2,0.001,1e-7, 4,0)


def test_ssx_3_1_2():
    s1, s2 = prepare_surfaces_case3()
    run_test_ssx(s2, s1, 0.001, 1e-7, 4, 0)

def test_ssx_3_2_1():
    s1,s2=prepare_surfaces_case3()
    run_test_ssx(s1,s2,0.01,1e-5, 4,0)


def test_ssx_3_2_2():
    s1, s2 = prepare_surfaces_case3()
    run_test_ssx(s2, s1, 0.01, 1e-5, 4, 0)
