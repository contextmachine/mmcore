...
def nurbs_curve(control_points, degree=None, rational=False, interval=None, periodic=False, **kwargs) -> NURBSCurveTuple:
    ...
    if rational:
        control_points, w = from_homogeneous_1d(control_points)
    else:
...
def nurbs_surface(control_points, degree_u=None, degree_v=None, rational=False, interval_u=None, interval_v=None,
                  periodic_u=False, periodic_v=False, **kwargs) -> NURBSSurfaceTuple:
